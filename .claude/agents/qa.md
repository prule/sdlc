...
3. Run the full test suite and the linter/build, capturing the real output. Confirm every task in `tasks.md` is actually done in the code, not just checked off.
